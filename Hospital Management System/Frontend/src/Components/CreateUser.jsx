...
function CreateUser() {
  ...
  return (
    <div className="bg-white ">
      <div className="bg-blue-200 mx-14 h-[860px] rounded-2xl flex ">
        <div className="flex-1">
          <h1 className="text-6xl text-center mt-10">Hi there !</h1>
          <div className="text-center mt-11">Welcome to Hospital, Community Dashboard</div>
          <form onSubmit={handleSubmit}>
            <div className="items-center flex justify-center flex-col gap-9">
              <input
                ...
                value={id}
                placeholder="ID/NIC"
                className="placeholder:text-gray-500 rounded-lg px-4 w-96 py-2 mt-10 text-1xl bg-blue-200 border-4 border-white"
                onChange={(e) => {
        ...
        <div className=" ">
           ...
           style={{ width: '1050px', height: '855px',marginRight:'5px' }} // Adjust the width as needed
           />
        </div>
      </div>
    </div>
