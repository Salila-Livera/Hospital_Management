    ...
    <div>
        <nav className='bg-white p-4 flex justify-between items-center'>
            ...
            <ul className=' flex flex-row gap-20'>
                ...
                <li><a href='/login' className='text-black bg-blue-300 rounded-full px-8 py-2 text-lg'>Login</a></li>
            <li><a href='/create' className=' mr-10 text-black bg-blue-400 rounded-full px-8 py-2 text-lg'>Register</a></li>
            </ul>
